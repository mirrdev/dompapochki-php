                            ...
                            <form class="needs-validation" novalidate method="post" action="{{$route}}">
                                ...
                                <div class="form-row mb-2">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" placeholder="@lang('panel.product.fields.title')" value="{{old('title')}}" required>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="slug" id="slug" placeholder="@lang('panel.product.fields.slug')" value="{{old('slug')}}" required>
                                        <div class="valid-tooltip">
                                            @lang('panel.message.valid')
                                        </div>
                                        <div class="invalid-tooltip">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea type="text" class="form-control" name="description" id="description" placeholder="@lang('panel.product.fields.description')" required>{{old('description')}}</textarea>
                                        <div class="valid-tooltip">
                                            @lang('panel.message.valid')
                                        </div>
                                        <div class="invalid-tooltip">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input id="thumbnail" type="hidden" class="form-control" name="filepath" id="filepath" placeholder="@lang('panel.product.fields.filepath')" value="{{old('filepath')}}" required>
                                    ...
                                    <?php for($i=1; $i<4; $i++) {?>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="<?='name'.$i?>" id="<?='name'.$i?>" placeholder="@lang('panel.product.fields.name'.$i)" value="{{old('name'.$i)}}">
                                            <div class="valid-tooltip">
                                                @lang('panel.message.valid')
                                            </div>
                                            <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="<?='detail'.$i?>" id="<?='detail'.$i?>" placeholder="@lang('panel.product.fields.detail'.$i)" value="{{old('detail'.$i)}}">
                                            <div class="valid-tooltip">
                                                @lang('panel.message.valid')
                                            </div>
                                            <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="<?='price'.$i?>" id="<?='price'.$i?>" placeholder="@lang('panel.product.fields.price'.$i)" value="{{old('price'.$i)}}" <?=($i==1)?'required':''?>>
                                            <div class="valid-tooltip">
                                                @lang('panel.message.valid')
                                            </div>
                                            <div class="invalid-tooltip">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea type="text" class="form-control editor" name="text" id="text" placeholder="@lang('panel.product.fields.text')" required>{{old('text')}}</textarea>
                                        <div class="valid-tooltip">
                                            @lang('panel.message.valid')
                                        </div>
                                        <div class="invalid-tooltip">
